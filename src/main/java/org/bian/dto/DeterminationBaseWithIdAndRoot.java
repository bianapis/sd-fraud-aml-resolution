 ...
 */
public class DeterminationBaseWithIdAndRoot   {
  private String fraudCaseReference = null;

  private String fraudCaseDeterminationRecordReference = null;
  ...
  **/
  ...
  /**
   * `status: Not Mapped` core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier 
   * @return fraudCaseDeterminationRecordReference
  **/

  public String getFraudCaseDeterminationRecordReference() {
    return fraudCaseDeterminationRecordReference;
  }

  public void setFraudCaseDeterminationRecordReference(String fraudCaseDeterminationRecordReference) {
    this.fraudCaseDeterminationRecordReference = fraudCaseDeterminationRecordReference;
  }
