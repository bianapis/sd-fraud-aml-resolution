...
public class ReportingBaseWithIdAndRoot   {
  ...
  private String fraudCaseReportingRecordReference = null;
  ...
  private Object fraudCaseReportingRecord = null;
  ...
  **/
  ...
  /**
   * `status: Not Mapped` core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier 
   * @return fraudCaseReportingRecordReference
  **/

  public String getFraudCaseReportingRecordReference() {
    return fraudCaseReportingRecordReference;
  }

  public void setFraudCaseReportingRecordReference(String fraudCaseReportingRecordReference) {
    this.fraudCaseReportingRecordReference = fraudCaseReportingRecordReference;
  }
  ...
  **/
  ...
  /**
   * `status: Not Mapped` core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Binary 
   * @return fraudCaseReportingRecord
  **/

  public Object getFraudCaseReportingRecord() {
    return fraudCaseReportingRecord;
  }

  public void setFraudCaseReportingRecord(Object fraudCaseReportingRecord) {
    this.fraudCaseReportingRecord = fraudCaseReportingRecord;
  }
